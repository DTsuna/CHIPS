...
! define initial trial temperature
      double precision temp_trial,e_th,muie,time
...
!      write(6,*)
      ...
      subroutine read_helm_iontable_e
      include 'implno.dek'
      include 'helm_table_storage.dek'
...
! end of pipeline loop
      ...
      subroutine pretty_eos_out_e(whose)
      include 'implno.dek'
      include 'vector_eos.dek'
